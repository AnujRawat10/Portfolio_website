...
export default function HowItWorksSection({
  title = "How I Work",
  subtitle = "A simple, transparent process to bring ideas to life",
  videoSrc,
  poster,
  badges = [
  ...
  overlayTitle = "Code + \n Creativity",
  overlayCopy = "I merge full stack development, AI, and data science with marketing insights to deliver impactful results.",
  bookLabel = "G20 summit Connect with PM",
  onBookNow,
  ratingText = "+10 Projects Completed",
  showOverlay = true,
}: Props) {
  return (
        ...
        <ol className="mx-auto mt-10 grid max-w-5xl grid-cols-1 gap-4 sm:gap-6 sm:grid-cols-3">
          <li className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-black/5">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Understand goals, research, and strategy
            </p>
          </li>
          ...
          <li className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-black/5">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Develop scalable and modern solutions
            </p>
          </li>
          ...
          <li className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-black/5">
            ...
            <p className="mt-2 text-sm text-gray-600">
Launch, optimize, and create lasting impact            </p>
          </li>
        </ol>
      </div>
    </section>
