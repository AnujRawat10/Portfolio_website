...
export default function ContactHero({
  ...
  subcopy = "In “I specialize in full stack development, AI-driven solutions, and data-powered strategies. Whether it’s building scalable web apps or creating engaging content, I’m here to help.",
  heroImage,
  heroAlt = "p1",
  badgeImage,
  badgeAlt = "Cute pet",
